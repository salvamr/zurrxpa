...
namespace Dumper
{
    namespace Remote
    {
        ...
        public:
            ...
            CModule( const std::string& name, const uintptr_t& imgsize, const intptr_t& imgbase );
            ~CModule( void );
...
#ifndef dDumper
#define dDumper Dumper::Remote::CProcess::Singleton( )
#endif /* dDumper */
